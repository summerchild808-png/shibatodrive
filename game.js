...
//  game.js  Part 1 (前半・高速完走＆エンディング直行修正版)
// ===============================
...
function init() {
  ...
  function processInputStart(canvasX, canvasY, buttonNum = 0) {
    ...
    // 🎬 ステージクリアカード表示後のタップ処理（下道4または高速99でエンディング直行！）
