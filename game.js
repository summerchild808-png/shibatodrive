...
const imageSources = {
  ...
  endCardHighway: 'end_card_highway.png',   // 高速道路クリアカード
  endCardShibuya: 'end_card_shibuya.png',   // 渋谷クリアカード
  endingStory: 'ending_story.png',           // 3コマ漫画
  thankYouCard: 'thank_you_card.png',       // サンキューカード
...
function init() {
  ...
  function processInputStart(canvasX, canvasY, buttonNum = 0) {
    ...
    if (gameState === 'STAGE_CLEAR' && endCardTimer >= END_CARD_DELAY) {
      // 渋谷クリア（4）、または高速走行（99）クリア時はどちらも「3コマエンディング」へ進む！
